...
const OthersFollowings: React.FC<FollowingModalProps> = ({ isOpen, onClose, user, sessionUser }) => {
  ...
  const handleFollowToggle = async (followingId: string) => {
    ...
    try {
        await toggleFollow(sessionUser._id, followingId, action);
...
export default OthersFollowings